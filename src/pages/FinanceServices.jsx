...
<div className="max-w-[1440px] mx-auto px-8 md:px-16 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center py-section-gap">
...
<button className="px-8 py-4 rounded-lg bg-gradient-to-r from-primary to-primary-fixed text-on-primary font-label-sm text-label-sm uppercase tracking-wider hover:opacity-90 transition-opacity border border-white/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.4)]">
                            Consult With Us
                        </button>
<button className="px-8 py-4 rounded-lg bg-surface-container-high text-on-background border border-outline-variant font-label-sm text-label-sm uppercase tracking-wider hover:bg-surface-variant transition-colors flex items-center gap-2">
                            View Methodology
...
<h2 className="font-headline-lg text-headline-lg text-on-background mb-6">Architectural Finance Solutions</h2>
...
<div className="md:col-span-2 rounded-2xl border border-outline-variant bg-surface-container-low p-10 flex flex-col justify-between relative overflow-hidden group hover:border-primary/50 transition-colors duration-300">
...
<div className="rounded-2xl border border-outline-variant bg-surface-container-low p-8 flex flex-col justify-between relative overflow-hidden group hover:border-primary/50 transition-colors duration-300">
<div className="z-10">
...
<div className="z-10 mt-8">
<button className="w-full py-3 rounded-lg bg-surface border border-outline-variant text-on-background font-label-sm text-label-sm hover:bg-surface-bright transition-colors">Explore Advisory</button>
</div>
</div>
...
<div className="md:col-span-2 rounded-2xl border border-outline-variant bg-surface-container-low p-8 flex flex-col justify-center items-center text-center relative overflow-hidden">
<div className="absolute inset-0 bg-cover bg-center opacity-20" data-alt="close up of complex financial charts and graphs on a digital screen with dark moody blue lighting" style={{"backgroundImage":"url('https://lh3.googleusercontent.com/aida-public/AB6AXuChR9YbgOzSbJTZ_faADfTZY7VjqQAxFeOaxL_PxiMPA-8iCmiZgNcjLQ5wUFqvEkUIMd7lf7vg7hwbVEvUYzobkgbKMlI3JO2MoJvF092643PiToUnezE9fdoLb95y9eiVRkSonnZN7PjN2QHhJzxgaNjXR4InAwoTxHZHTYw-ub-QofFl437O2I47piha8-Nay78p8BclKI_ID-hKM3CAhuhPM36mVmSxehC1cbXLSI7WYvUMYMAG-B4YGK88yap9jmFKNdxqB70')"}}></div>
...
<button className="px-6 py-3 rounded-lg border border-outline text-on-background font-label-sm text-label-sm uppercase tracking-wide hover:bg-white/5 transition-colors">Request a Demo</button>
</div>
</div>
</div>
</div>
...
<h2 className="font-headline-lg text-headline-lg text-on-background mb-6">The Methodology</h2>
...
<div className="relative border-l border-outline-variant/50 ml-4 md:ml-[50%] space-y-20">

<div className="relative pl-12 md:pl-0 md:w-1/2 md:pr-16 md:-ml-[50%] text-left md:text-right group">
<div className="absolute left-[-5px] md:right-[-5px] md:left-auto top-2 w-3 h-3 rounded-full bg-surface border-2 border-primary group-hover:bg-primary transition-colors z-10"></div>
...
<div className="relative pl-12 md:pl-16 w-full md:w-1/2 md:ml-0 group">
<div className="absolute left-[-5px] top-2 w-3 h-3 rounded-full bg-surface border-2 border-secondary group-hover:bg-secondary transition-colors z-10"></div>
...
<div className="relative pl-12 md:pl-0 md:w-1/2 md:pr-16 md:-ml-[50%] text-left md:text-right group">
<div className="absolute left-[-5px] md:right-[-5px] md:left-auto top-2 w-3 h-3 rounded-full bg-surface border-2 border-tertiary group-hover:bg-tertiary transition-colors z-10"></div>
...
<div className="relative pl-12 md:pl-16 w-full md:w-1/2 md:ml-0 group">
<div className="absolute left-[-5px] top-2 w-3 h-3 rounded-full bg-surface border-2 border-primary-container group-hover:bg-primary-container transition-colors z-10"></div>
...
<div className="relative pl-12 md:pl-0 md:w-1/2 md:pr-16 md:-ml-[50%] text-left md:text-right group">
<div className="absolute left-[-5px] md:right-[-5px] md:left-auto top-2 w-3 h-3 rounded-full bg-surface border-2 border-outline group-hover:bg-on-background transition-colors z-10"></div>
...
<div className="rounded-3xl border border-outline-variant/50 bg-surface-container/40 backdrop-blur-2xl p-12 md:p-24 text-center max-w-5xl mx-auto shadow-2xl">
<h2 className="font-headline-lg text-headline-lg text-on-background mb-6">Ready to Reengineer Your Capital Strategy?</h2>
<p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-12">Connect with our senior partners to discuss your institutional objectives and discover how Alpha Wings Tech Group can accelerate your financial trajectory.</p>
<button className="px-10 py-5 rounded-lg bg-on-background text-background font-label-sm text-label-sm uppercase tracking-wider hover:bg-outline transition-colors shadow-[0_0_20px_rgba(220,228,227,0.1)] hover:shadow-[0_0_30px_rgba(220,228,227,0.2)]">
                        Get in Touch
                    </button>
</div>
</div>
