      ...
      <div className="max-w-container-max mx-auto px-margin-edge">
        <div className="mb-8">
          <Link to={-1} className="text-primary hover:underline flex items-center gap-2 w-fit">
            <span className="material-symbols-outlined">arrow_back</span> Back to Government Services
          </Link>
        </div>
        <div className="glass-panel p-10 rounded-xl relative overflow-hidden group">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl mb-8">
            Comprehensive details and in-depth methodologies for our Digital Services Consulting services. We provide top-tier expertise and specialized solutions to meet the most demanding enterprise requirements.
          </p>
