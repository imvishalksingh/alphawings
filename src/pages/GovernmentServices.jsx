...
<div className="glass-panel p-10 rounded-xl relative overflow-hidden group hover:bg-surface-container-high transition-all duration-500">
...
<div className="glass-panel p-10 rounded-xl relative overflow-hidden group hover:bg-surface-container-high transition-all duration-500 md:col-span-2">
...
<div className="glass-panel p-10 rounded-xl relative overflow-hidden group hover:bg-surface-container-high transition-all duration-500 md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
<div>
