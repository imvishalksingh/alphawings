...
<section className="max-w-container-max mx-auto px-margin-edge pt-20 pb-section-gap">
...
<h1 className="font-display-xl text-display-xl text-on-surface">
                        Data-Driven <br/>
<span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Political Victory</span>
</h1>
<p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
                        Architecting campaigns with precision. We leverage advanced analytics, behavioral targeting, and strategic narrative engineering to secure electoral dominance and shape public consensus.
                    </p>
<div className="flex flex-wrap gap-4 pt-4">
<button className="bg-gradient-to-r from-primary-container to-primary/80 text-on-primary-container px-8 py-4 rounded-lg font-body-md text-body-md font-semibold border border-primary/30 inner-glow hover:shadow-[0_0_20px_rgba(183,196,255,0.2)] transition-all">
                            Initiate Strategy
                        </button>
<button className="bg-surface-variant/50 text-on-surface px-8 py-4 rounded-lg font-body-md text-body-md border border-outline-variant inner-glow hover:bg-surface-variant transition-all backdrop-blur-md">
                            View Case Studies
                        </button>
</div>
</div>
<div className="lg:col-span-5 relative h-[600px] w-full rounded-2xl overflow-hidden border border-outline-variant/20 inner-glow">
...
<img alt="Data visualization" className="absolute inset-0 w-full h-full object-cover grayscale opacity-60" data-alt="abstract data visualization with glowing blue nodes and connecting lines on a dark background representing strategic network analysis" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDLpdvZ27s6maWzHLHJW2GiI2BhFROFKdoJf1He8v4G3cdYibjd95_-N0A9HF2UDz7r7QiPZ-_N4imJzUh3a0A59bqFOcJws7YbIQAI5Sodd4pOyouKfsOi0whlsq61xIu15oy5XJF2NVgu51kQWsuAkIVIK9GvrYRiL3Ffp3rW__oGUsqax-NLSHNhO95rq9LI3Bh35oAdzkFY-KjgM6_ugr-2cXoTqvSjA3eK5Z3WjGMdLhiTGRl4s8SthUCmP3Rfxf5vk9oVMxw"/>
</div>
</div>
</section>

<section className="max-w-container-max mx-auto px-margin-edge py-section-gap relative">
<div className="mb-16">
...
<section className="border-t border-outline-variant/20 bg-surface-container-lowest py-section-gap relative overflow-hidden">
...
<div className="lg:absolute top-1/2 left-1/2 lg:-translate-y-1/2 lg:-translate-x-1/2 w-4 h-4 rounded-full bg-surface border-2 border-primary z-10 mb-4 lg:mb-0 shadow-[0_0_10px_rgba(183,196,255,0.5)]"></div>
...
<div className="relative pt-8 lg:pt-0">
<div className="lg:absolute top-1/2 left-1/2 lg:-translate-y-1/2 lg:-translate-x-1/2 w-4 h-4 rounded-full bg-surface border-2 border-secondary z-10 mb-4 lg:mb-0 shadow-[0_0_10px_rgba(121,219,147,0.5)]"></div>
...
<div className="relative pt-8 lg:pt-0">
<div className="lg:absolute top-1/2 left-1/2 lg:-translate-y-1/2 lg:-translate-x-1/2 w-4 h-4 rounded-full bg-primary z-10 mb-4 lg:mb-0 shadow-[0_0_15px_rgba(183,196,255,0.8)]"></div>
