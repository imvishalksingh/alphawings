...
<main className="flex-grow pt-24 md:pt-32 pb-16 md:pb-section-gap px-margin-edge w-full max-w-container-max mx-auto">
...
<div className="mb-12 md:mb-16 text-center lg:text-left">
    <h1 className="font-display-xl text-display-xl text-on-background mb-4">Core Divisions</h1>
    <p className="font-body-lg text-on-surface-variant max-w-2xl mx-auto lg:mx-0">Comprehensive enterprise solutions engineered for global market leadership.</p>
</div>

<section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 auto-rows-auto md:auto-rows-[320px]">

<div className="md:col-span-2 md:row-span-2 bg-surface-container rounded-xl inner-glow radial-gradient-bg p-8 md:p-10 flex flex-col justify-between group overflow-hidden relative card-hover transition-all duration-500 border border-outline-variant/30 min-h-[400px] md:min-h-0">
...
<div className="bg-surface-container rounded-xl inner-glow radial-gradient-bg p-8 flex flex-col justify-between group relative card-hover transition-all duration-500 border border-outline-variant/30 min-h-[250px] md:min-h-0">
<div className="relative z-10 flex justify-between items-start">
...
<p className="font-body-md text-body-md text-on-surface-variant mb-6 text-sm">Strategic capital allocation, risk management, and institutional wealth structuring designed for long-term stability.</p>
...
<p className="font-body-md text-body-md text-on-surface-variant mb-6 text-sm">Public sector consulting, policy implementation, and civic infrastructure management.</p>
...
<div className="md:col-span-2 bg-surface-container rounded-xl inner-glow radial-gradient-bg p-8 md:p-10 flex flex-col justify-between group relative card-hover transition-all duration-500 border border-outline-variant/30 min-h-[300px] md:min-h-0">
<div className="relative z-10 flex justify-between items-start">
...
<p className="font-body-md text-body-md text-on-surface-variant mb-6 text-sm">Data-driven audience acquisition, omnichannel campaign execution, and performance analytics.</p>
...
<p className="font-body-md text-body-md text-on-surface-variant mb-6 text-sm">Corporate identity architecture, visual systems, and brand positioning for global markets.</p>
...
<div className="md:col-span-2 lg:col-span-1 xl:col-span-2 bg-surface-container rounded-xl inner-glow radial-gradient-bg p-8 flex flex-col justify-between group relative card-hover transition-all duration-500 border border-outline-variant/30 overflow-hidden min-h-[280px] md:min-h-0">
...
<div className="md:col-span-2 xl:col-span-4 bg-[#1a232e] rounded-xl inner-glow p-8 md:p-12 flex flex-col md:flex-row justify-between items-center group relative card-hover transition-all duration-500 border border-primary/20 overflow-hidden">
...
<h3 className="font-display-xl text-3xl md:text-4xl text-white mb-4 uppercase tracking-tighter">Alpha Infrastructure</h3>
...
<Link className="w-full sm:w-auto bg-primary text-on-primary px-8 py-3 rounded-lg font-bold uppercase tracking-wider hover:shadow-[0_0_20px_rgba(183,196,255,0.2)] transition-all inline-flex items-center justify-center gap-3" to="/services/infrastructure">
                        Enter Infrastructure Division <span className="material-symbols-outlined text-sm">arrow_forward</span>
</Link>
</div>
<div className="hidden lg:block relative z-10 w-1/3 mt-8 md:mt-0">
<img 
